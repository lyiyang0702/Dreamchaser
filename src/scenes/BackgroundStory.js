...
class Story extends Phaser.Scene {
    constructor() {
        ...
        this.SKIP_TEXT = '[PRESS X TO SKIP]';	// text to display for next prompt
        this.SKIP_X = 1200;			// next text prompt x-position
        this.SKIP_Y = 100;
    ...
    create() {
        ...
        this.skipText = this.add.bitmapText(this.SKIP_X, this.SKIP_Y, this.DBOX_FONT, '', this.TEXT_SIZE);
            ...
            this.textTimer = this.time.addEvent({
                ...
                callback: () => { 
                    ...
                    if(this.textTimer.getRepeatCount() == 0) {
                        ...
                        this.skipText = this.add.bitmapText(this.SKIP_X, this.SKIP_Y, this.DBOX_FONT, this.SKIP_TEXT, this.TEXT_SIZE).setOrigin(1);
                        // un-lock input
